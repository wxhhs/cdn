...
install_depend() {
    if check_sys sysRelease ubuntu;then
        ...
        yum install -y wget python curl ca-certificates
    fi    
}
...
if [[ $VER == "" ]]; then
  # 获取最新版本
  echo "获取最新版..."
  latest_version=`(curl -v -m 5 'https://raw.githubusercontent.com/wxhhs/cdn/main/upgrades-50800.json' || curl -v -m 5 'https://raw.githubusercontent.com/wxhhs/cdn/main/upgrades-50800.json') | grep -Po 'v\d+\.\d+.\d+' || true`
